...
public class StorageService{
    ...
    private String containerName = "storageup-test";
    // mod SunFuji 20171119
    private final String connectionString ="DefaultEndpointsProtocol=https;AccountName=yoshiofileup;AccountKey=n**************************************************==;EndpointSuffix=core.windows.net";
